      ...
      <div className={s.cartItem}>
        ...
        {!isGift && (
          <ButtonCount
            amount={quantity}
            handleIncrement={() => {
              dispatch(incrementQuantity(addDataProduct));
            }}
            handleDecrement={() => {
              dispatch(decrementQuantity(addDataProduct));
            }}
            handleCountChange={(newQuantity) => {
              dispatch(
                changeCartQuantity({ ...addDataProduct, quantity: newQuantity })
              );
            }}
          />
        )}
        ...
        {!isGift && (
          <button
            ...
            onClick={() => {
              dispatch(removeProductCart(addDataProduct));
            }}
          >
            <TrashIcon />
          </button>
